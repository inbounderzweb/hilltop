...
//   // Safety: outside click closes (capture phase)
//   useEffect(() => {
...
//   // When menu closes, close products
//   useEffect(() => {
...
//   return (
//     <>
//       {/* Backdrop: ALWAYS closes on click (fixes your closing issue 100%) */}
//       <button
//         type="button"
...
//         {/* ================= MOBILE MENU PANEL ================= */}
//         <div className="md:hidden w-[min(420px,calc(100%-60px))] mx-auto mt-[18px] bg-[#373737]/90 backdrop-blur-md rounded-[18px] py-4">
