  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:bg-[#128C7E] transition-all duration-300 transform group-hover:scale-110">
          <svg 
            viewBox="0 0 24 24" 
